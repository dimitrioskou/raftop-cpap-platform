# RAFTOP CPAP CARE Pro - Phase 38.3 Repository Safety Scan Result

Generated: 2026-05-24 10:08:38
...
STATUS: FAIL
DETAILS: Disallowed production env files found: enterprise-frontend\.env.production; raftop-admin\.env.production

CHECK: Local env files
STATUS: WARN
DETAILS: Local .env files exist. Do not commit them: backend\.env; enterprise-backend\.env; enterprise-frontend\.env
...
CHECK: Hardcoded PostgreSQL URL
STATUS: FAIL
...
CHECK: Hardcoded JWT_SECRET assignment
STATUS: WARN
...
CHECK: Hardcoded SUPER_ADMIN_API_KEY assignment
STATUS: WARN
DETAILS: enterprise-backend\.env: line 23; enterprise-backend\.env.production.example: line 15; enterprise-frontend\.env: line 3

CHECK: Hardcoded RESTORE_KEY assignment
STATUS: PASS
DETAILS: No RESTORE_KEY= assignments found in scanned files.

CHECK: Potential API key pattern
STATUS: WARN
