...
function NavigationLinks() {
  ...
  return (
    <nav style={nav}>
      <div style={navGroup}>
        <div style={navTitle}>Παρουσίαση</div>
      ...
      <div style={navGroup}>
        <div style={navTitle}>Λειτουργία Πλατφόρμας</div>
      ...
      {demo && !technicalUnlocked && (
        <div style={clientSafeBox}>
          ...
          <div style={clientSafeText}>
            Η παρουσίαση είναι καθαρή για πελάτη. Οι τεχνικές σελίδες και τα internal audits είναι κρυμμένα.
          </div>
        </div>
      )}
