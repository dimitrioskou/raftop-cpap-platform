...
export default function TenantTasksPage() {
  ...
  async function handleTransition(task, transition) {
    ...
    try {
      const payload = await apiRequest(
        `/api/tenant/tasks-unified/${encodeURIComponent(taskId)}/${transition}`,
        {
          ...
          body: {
            ...
            phase: '19.23-frontend-transition-buttons'
          },
      ...
      setFlashMessage(
        `Task updated: ${transitionLabel(transition)} → ${statusLabel(nextStatus)}.`
      );
    ...
    <div className="tenant-tasks-page">
      ...
      <section className="hero-card">
        <div>
          ...
          <h1>Tenant Tasks</h1>
          <p>
            Ενιαία προβολή των ATLAS-generated follow-up tasks. Το Phase 19.23 προσθέτει
            πραγματικά workflow buttons για Start, Escalate, Resolve και Reopen.
          </p>
