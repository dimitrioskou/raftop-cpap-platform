...
function getSignalKind(item) {
  return firstValue(item?.signalKind, item?.signal_kind, item?.kind, 'β€”');
}
    ...
    <section className={`action-evidence-card ${tone}`}>
      <div className="action-evidence-header">
        <div>
          ...
          <p>
            Ξ‘Ο€ΟΞ΄ΞµΞΉΞΎΞ· Ο„ΞΏΟ… Ο„ΞµΞ»ΞµΟ…Ο„Ξ±Ξ―ΞΏΟ… operation: Ο„ΞΉ task Ξ΄Ξ·ΞΌΞΉΞΏΟ…ΟΞ³Ξ®ΞΈΞ·ΞΊΞµ, Ξ±Ξ½ Ξ­Ξ³ΞΉΞ½Ξµ writeback,
            ΞΊΞ±ΞΉ ΟƒΞµ Ο€ΞΏΞΉΞΏ linked context ΟƒΟ…Ξ³Ο‡ΟΞΏΞ½Ξ―ΟƒΟ„Ξ·ΞΊΞµ.
          </p>
        </div>
      ...
      {evidence.error ? (
        <div className="evidence-error">
          Ξ¤ΞΏ action ΞµΞΊΟ„ΞµΞ»Ξ­ΟƒΟ„Ξ·ΞΊΞµ, Ξ±Ξ»Ξ»Ξ¬ Ο…Ο€Ξ¬ΟΟ‡ΞµΞΉ writeback error. Ξ‘Ο…Ο„Ο ΞΈΞ­Ξ»ΞµΞΉ backend/data check Ο€ΟΞΉΞ½ ΞΈΞµΟ‰ΟΞ·ΞΈΞµΞ― ΞΊΞ»ΞµΞΉΟƒΟ„Ο.
        </div>
      ) : null}
    </section>
  );
...
export default function TenantAtlasActionCenterPage() {
  ...
  async function loadData(preferredId = '', options = {}) {
    ...
    try {
      const payload = await apiRequest('/api/tenant/atlas', {
    ...
    try {
      ...
      setFlashMessage(
        evidence.status && evidence.status !== 'unknown'
          ? `Ξ¤ΞΏ task ΟƒΟ…Ξ³Ο‡ΟΞΏΞ½Ξ―ΟƒΟ„Ξ·ΞΊΞµ. Writeback status: ${writebackLabel(evidence.status)}.`
          : 'Ξ¤ΞΏ task Ξ΄Ξ·ΞΌΞΉΞΏΟ…ΟΞ³Ξ®ΞΈΞ·ΞΊΞµ Ξ® ΞµΟ€Ξ±Ξ½Ξ±Ο‡ΟΞ·ΟƒΞΉΞΌΞΏΟ€ΞΏΞΉΞ®ΞΈΞ·ΞΊΞµ ΞµΟ€ΞΉΟ„Ο…Ο‡ΟΟ‚ Ξ±Ο€Ο Ο„ΞΏ ATLAS Action Center.'
      );

      await loadData(actionId, { preserveFlash: true });
    } catch (error) {
      setFlashMessage(error?.message || 'Ξ‘Ο€ΞΏΟ„Ο…Ο‡Ξ―Ξ± Ξ΄Ξ·ΞΌΞΉΞΏΟ…ΟΞ³Ξ―Ξ±Ο‚ task');
      setLastActionEvidence({
        actionId,
        action: 'create_task',
        ok: false,
        status: 'failed',
        signalStatus: fallbackContext.signalStatus || 'β€”',
        coachingStatus: fallbackContext.coachingStatus || 'β€”',
        signalId: fallbackContext.signalId || 'β€”',
        coachingContextId: fallbackContext.coachingContextId || 'β€”',
        createdTaskId: 'β€”',
    ...
    <div className="tenant-atlas-action-center-page">
      ...
      <section className="hero-card">
        <div>
          ...
          <p>
            Ξ•Ξ½ΞΉΞ±Ξ―Ξ± operational Ο€ΟΞΏΞ²ΞΏΞ»Ξ® Ξ³ΞΉΞ± patient signals, failed imports ΞΊΞ±ΞΉ coaching-driven follow-up.
            Ξ¤ΞΏ Phase 19.18 Ξ΄ΞΉΞΏΟΞΈΟΞ½ΞµΞΉ Ο„ΞΏ deep link: ΟΟ„Ξ±Ξ½ Ξ΄ΞµΞ½ Ο…Ο€Ξ¬ΟΟ‡ΞµΞΉ Ο€ΟΞ±Ξ³ΞΌΞ±Ο„ΞΉΞΊΟ patient email,
            Ο„ΞΏ linked task Ξ±Ξ½ΞΏΞ―Ξ³ΞµΞΉ ΟƒΟ„ΞΏ unified task board Ξ±Ξ½Ο„Ξ― Ξ³ΞΉΞ± ΟΞµΟΟ„ΞΉΞΊΞΏ patient fallback.
          </p>
        </div>
      ...
      {fallbackMode ? (
        <div className="banner warning">
          ATLAS Action Center ΟƒΞµ fallback mode. Ξ•ΞΌΟ†Ξ±Ξ½Ξ―Ξ¶ΞΏΞ½Ο„Ξ±ΞΉ demo Ξ΄ΞµΞ΄ΞΏΞΌΞ­Ξ½Ξ±. Ξ¤ΞΏ writeback UI Ο†Ξ±Ξ―Ξ½ΞµΟ„Ξ±ΞΉ,
          Ξ±Ξ»Ξ»Ξ¬ Ξ΄ΞµΞ½ ΞµΟ€ΞΉΞ²ΞµΞ²Ξ±ΞΉΟΞ½ΞµΞΉ Ο€ΟΞ±Ξ³ΞΌΞ±Ο„ΞΉΞΊΟ backend sync.
        </div>
      ) : (
        <div className="banner success">
          Live ATLAS backend connected. Ξ¤Ξ± writeback states Ο€ΟΞΏΞ­ΟΟ‡ΞΏΞ½Ο„Ξ±ΞΉ Ξ±Ο€Ο Ο„ΞΏ Ο€ΟΞ±Ξ³ΞΌΞ±Ο„ΞΉΞΊΟ endpoint.
        </div>
      )}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="action-meta">
                      {item.subtitle || getPatientEmail(item) || item.patient_name || item.patientName || 'β€”'}
                    </div>
          ...
          {selectedItem ? (
            <div className="detail-wrap">
              ...
              <div className="detail-row">
                ...
                <span>{getSignalId(selectedItem) || 'β€”'}</span>
              </div>
              ...
              <div className="detail-row">
                ...
                <span>{getLinkedTaskId(selectedItem) || 'β€”'}</span>
              </div>
